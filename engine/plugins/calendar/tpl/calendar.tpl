				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td style="background-image:url('{{ tpl_url }}/images/2z_36.gif');" width="100%">
							&nbsp;<b><font color="#FFFFFF">Календарь</font></b></td>
						...
						<td bgcolor="#FFFFFF">
							<div class="block_cal" align="left">
								<table id="calendar" align="center">
									<tr>
										<td class="month" onclick="ng_calendar_walk({{ currentEntry.month }}, {{ currentEntry.year }}, 'prev'); return false;">
											[prev_link]&laquo;[/prev_link]
										</td>
										<td colspan="5" class="month">
											<a href="{{ currentMonth.link }}">{{ currentMonth.name }}</a></td>
										<td class="month" onclick="ng_calendar_walk({{ currentEntry.month }}, {{ currentEntry.year }}, 'next'); return false;">
											[next_link]&raquo;[/next_link]
										</td>
									</tr>
									<tr>
