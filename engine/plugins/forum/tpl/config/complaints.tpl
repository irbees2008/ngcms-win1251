<table border="0" cellspacing="0" cellpadding="0" class="content" align="center">
	...
	{% for entry in entries %}
		<tr align="left">
			...
			<td class="contentEntry1">{{ entry.author }}<br/>
				<small><a href="{{ entry.author_link }}">{{ entry.home_url }}{{ entry.author_link }}</a></small>
			</td>
			<td class="contentEntry1">{{ entry.message }}<br/>
				<small><a href="{{ entry.post_link }}">{{ entry.home_url }}{{ entry.post_link }}#{{ entry.post_id }}</a>
				</small>
			</td>
