	...
	<table width="97%" class="content" border="0" cellspacing="0" cellpadding="0" align="center">
		...
		{% for entry in entries %}
			<tr align="center" class="contRow1">
				...
				<td>
					<a href="admin.php?mod=extra-config&plugin=forum&action=ban_ip_list_del&ip={{ entry.ip }}"><img src="{{ admin_url }}/plugins/forum/tpl/config/images/dell.png" title="Удалить" alt="Удалить" border="0"/></a>
				</td>
			</tr>
		{% endfor %}
	</table>
