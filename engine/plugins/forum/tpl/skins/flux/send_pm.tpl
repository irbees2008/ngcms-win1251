		...
		<form method="post" id="post" action="">
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						<div class="rbox">
							<label><input type="checkbox" name="savemessage" value="1" checked="checked" tabindex="5"/>Сохранить
								сообщение<br/></label>
						</div>
					</div>
				</fieldset>
			...
			<p>
				<input type="submit" name="submit" value="Отправить" tabindex="6" accesskey="s"/><a href="javascript:history.go(-1)">Вернуться
					назад</a></p>
		</form>
	</div>
</div>