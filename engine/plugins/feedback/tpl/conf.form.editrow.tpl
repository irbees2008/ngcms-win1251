...
<form action="?mod=extra-config&plugin=feedback&action=editrow&form_id={{ formID }}&name={{ fieldName }}" method="post" name="feedbackform">
	...
	<table border="0" cellspacing="1" cellpadding="1" class="content">
		...
		<tr class="contRow1">
			<td width="50%">јвтозаполнение:<br/>
				<small><b>Ќет</b> - пользователь должен самосто€тельно заполн€ть поле<br/><b>параметром</b> - значение
					пол€ может передаватьс€ в качестве параметра к URL'у вызова<br/><b>св€зкой с новостью</b> - значение
					пол€ может братьс€ из одноимЄнного пол€ плагина <b>xfields</b> св€занной новости<br/><b>св€зка с
						профилем</b> - значение пол€ может братьс€ из одноимЄнного пол€ плагина <b>xfields</b> профил€
					пользовател€
				</small>
			</td>
			<td>
		...
		<tr class="contRow1">
			<td width="50%">Ѕлокировка:<br/>
				<small><b>Ќет</b> - поле доступно дл€ редактировани€<br/><b>ƒа</b> - пользователь не может редактировать
					данное поле<br/><b>ƒа, невидимо</b> - поле невидимо, его редактирование запрещено
				</small>
			</td>
			<td>
				<select name="block">
