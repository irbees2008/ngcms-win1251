...
if (count($_POST) > 0) {
	$response = $wmxi->X16(
		$_POST["wmid"],            # ¬ћ-идентификатор, которому будет принадлежать вновь созданный кошелек
		$_POST["pursetype"],       # “ип создаваемого кошелька в виде одного латинского символа в верхнем регистре B ,C ,D ,E ,G ,R ,U ,Y ,Z.
		trim($_POST["desc"])       # текстовое название кошелька, которое будет отображатьс€ в интерфейсе Webmoney Keeper Classic или Light.
	);
...
<a href="https://wiki.webmoney.ru/wiki/show/%d0%98%d0%bd%d1%82%d0%b5%d1%80%d1%84%d0%b5%d0%b9%d1%81+X16">https://wiki.webmoney.ru/wiki/show/»нтерфейс+X16</a>
<br/>
...
<form action="" method="post">
	...
	<input type="submit" value="создать кошелЄк"/>
	<br/>
