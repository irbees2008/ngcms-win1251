...
<tr>
<td width=100% colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" /><a href="?mod=ugroup">{{ lang['user_groups'] }}</a> &#8594; {% if flags.editMode %} {{ lang['edit_group'] }} "{{ entry.identity }}" [ {{ entry.id }} ]{% else %}{{ lang['add_group'] }}{% endif %}</td>
</tr>
<tr>
