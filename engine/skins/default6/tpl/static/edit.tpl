...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
   ...
   <td><input type="text" class="important" size="79" name="title" value="{{ data.title }}" tabindex="1" /></td>
  </tr>
  <tr>
   <td><img src="{{ skins_url }}/images/nav.png" hspace="8" alt="" /></td>
   <td>{{ lang['alt_name'] }}:</td>
   <td><input type="text" name="alt_name" value="{{ data.alt_name }}" size="79" tabindex="3" /></td>
  </tr>
...
{% if (flags.meta) %}
  <tr>
   ...
   <td><input type="text" name="description" value="{{ data.description }}" size="60" tabindex="4" /></td>
  </tr>
  <tr>
   <td><img src="{{ skins_url }}/images/nav.png" hspace="8" alt="" /></td>
   <td>{{ lang['keywords'] }}:</td>
   <td><input type="text" name="keywords" value="{{ data.keywords }}" size="60" tabindex="5" /></td>
  </tr>
  <tr>
   <td><img src="{{ skins_url}}/images/nav.png" hspace="8" alt="" /></td>
   <td>{{ lang['postdate'] }}</td>
...
<!--  <tr><td colspan=2>&nbsp;</td></tr> -->
  ...
  <tr><td></td><td>
  	<div class="list">
	<select name="template" style="width: 200px;">{% for t in templateList %}<option value="{{ t }}" {% if (data.template == t) %}selected="selected"{% endif %}>{{ t }}{% endfor %}</select><br/><br/>
...
{% if (flags.canModify) %}<input type="submit" value="{{ lang['do_editnews'] }}" class="button" />&nbsp;
