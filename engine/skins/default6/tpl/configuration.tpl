...
<div class="page-main">
	...
	<form method="post" action="{{ php_self }}">
		...
		<!-- ########################## DB TAB ########################## -->
	<div id="userTabs-db" class="tab-pane fade active in">
		<!-- TABLE DB//Connection -->
		<table class="table table-condensed">
			...
			<tr>
				...
				<td width="50%"><input type="text" class="form-control" name="save_con[dbhost]" value="{{ config['dbhost'] }}" id="db_dbhost" /></td>
			</tr>
			<tr>
				<td width="50%">{{ lang['dbname'] }}<br /><small>{{ lang['example'] }} ng</small></td>
				<td width="50%"><input type="text" class="form-control" name="save_con[dbname]" value="{{ config['dbname'] }}" id="db_dbname" /></td>
			</tr>
			<tr>
				<td width="50%">{{ lang['dbuser'] }}<br /><small>{{ lang['example'] }} root</small></td>
				<td width="50%"><input type="text" class="form-control" name="save_con[dbuser]" value="{{ config['dbuser'] }}" id="db_dbuser" /></td>
			</tr>
			<tr>
				<td width="50%">{{ lang['dbpass'] }}<br /><small>{{ lang['example'] }} password</small></td>
				<td width="50%"><input type="password" class="form-control" name="save_con[dbpasswd]" value="{{ config['dbpasswd'] }}" id="db_dbpasswd" /></td>
			</tr>
			<tr>
				<td width="50%">{{ lang['dbprefix'] }}<br /><small>{{ lang['example'] }} ng</small></td>
				<td width="50%"><input type="text" class="form-control" name="save_con[prefix]" value="{{ config['prefix'] }}" /></td>
			</tr>
			<tr>
				<td width="50%">&nbsp;</td>
				<td width="50%"><input type="button" class="btn btn-default" value="{{ lang['btn_checkDB'] }}" onclick="ngCheckDB(); return false;"/></td>
			</tr>
		</table>
	...
	<!-- ########################## SECURITY TAB ########################## -->
	<div id="userTabs-security" class="tab-pane fade">
		<table class="table table-condensed">
		<tr>
		<td colspan="2" class="h3">{{ lang['logging'] }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['x_ng_headers'] }}<br /><small>{{ lang['x_ng_headers#desc'] }}</small></td>
		<td>{{ mkSelectNY({'name' : 'save_con[x_ng_headers]', 'value' : config['x_ng_headers'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['syslog'] }}<br /><small>{{ lang['syslog_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[syslog]', 'value' : config['syslog'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['load'] }}<br /><small>{{ lang['load_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[load_analytics]', 'value' : config['load_analytics'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['load_profiler'] }}<br /><small>{{ lang['load_profiler_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['flood_time'] }}<br /><small>{{ lang['flood_time_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[flood_time]' value='{{ config['flood_time'] }}' size="6" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_captcha'] }}<br /><small>{{ lang['use_captcha_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_captcha]', 'value' : config['use_captcha'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['captcha_font'] }}<br /><small>{{ lang['captcha_font_desc'] }}</small></td>
		<td>{{ mkSelect({'name' : 'save_con[captcha_font]', 'value' : config['captcha_font'], 'values' : list['captcha_font'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_cookies'] }}<br /><small>{{ lang['use_cookies_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_cookies]', 'value' : config['use_cookies'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_sessions'] }}<br /><small>{{ lang['use_sessions_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_sessions]', 'value' : config['use_sessions'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['sql_error'] }}<br /><small>{{ lang['sql_error_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['multiext_files'] }}<br /><small>{{ lang['multiext_files_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['debug'] }}<br /><small>{{ lang['debug_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[debug]', 'value' : config['debug'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['debug_queries'] }}<br /><small>{{ lang['debug_queries_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[debug_queries]', 'value' : config['debug_queries'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['debug_profiler'] }}<br /><small>{{ lang['debug_profiler_desc'] }}</small></td>
	...
	<!-- ########################## SYSTEM TAB ########################## -->
	<div id="userTabs-system" class="tab-pane fade">
		<table class="table table-condensed">
		<tr>
		<td colspan="2" class="h3">{{ lang['syst'] }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['home_url'] }}<br /><small>{{ lang['example'] }} http://server.com</small></td>
		<td><input class="home" type="text" name='save_con[home_url]' value='{{ config['home_url'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['admin_url'] }}<br /><small>{{ lang['example'] }} http://server.com/engine</small></td>
		<td><input class="home" type="text" name='save_con[admin_url]' value='{{ config['admin_url'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['home_title'] }}<br /><small>{{ lang['example'] }} NGcms</small></td>
		<td><input type="text" class="form-control" name='save_con[home_title]' value="{{ config['home_title']|escape }}" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['admin_mail'] }}<br /><small>{{ lang['example'] }} admin@server.com</small></td>
		<td><input class="email" type="text" name='save_con[admin_mail]' value='{{ config['admin_mail'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['lock'] }}<br /><small>{{ lang['lock_desc'] }}</small></td>
		<td>{{ mkSelectNY({'name' : 'save_con[lock]', 'value' : config['lock'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['lock_reason'] }}<br /><small>{{ lang['lock_reason_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[lock_reason]' value='{{ config['lock_reason'] }}' maxlength="200" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['meta'] }}<br /><small>{{ lang['meta_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[meta]', 'value' : config['meta'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['description'] }}<br /><small>{{ lang['description_desc'] }}</small></td>
		<td><input type="text" class="form-control" name="save_con[description]" value="{{ config['description'] }}" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['keywords'] }}<br /><small>{{ lang['keywords_desc'] }}</small></td>
		<td><input type="text" class="form-control" name="save_con[keywords]" value="{{ config['keywords'] }}" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['theme'] }}<br /><small>{{ lang['theme_desc'] }}</small></td>
		<td>{{ mkSelect({'name' : 'save_con[theme]', 'value' : config['theme'], 'values' : list['theme'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['lang'] }}<br /><small>{{ lang['lang_desc'] }}</small></td>
		<td>{{ mkSelect({'name' : 'save_con[default_lang]', 'value' : config['default_lang'], 'values' : list['default_lang'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_gzip'] }}<br /><small>{{ lang['use_gzip_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_gzip]', 'value' : config['use_gzip'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['404_mode'] }}<br /><small>{{ lang['404_mode_desc'] }}</small></td>
		<td>{{ mkSelect({'name' : 'save_con[404_mode]', 'value' : config['404_mode'], 'values' : { 0 : lang['404.int'], 1 : lang['404.ext'], 2 : lang['404.http'] } }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['libcompat'] }}<br /><small>{{ lang['libcompat_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[libcompat]', 'value' : config['libcompat'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['url_external_nofollow'] }}<br /><small>{{ lang['url_external_nofollow_desc'] }}</small></td>
		<td>{{ mkSelectNY({'name' : 'save_con[url_external_nofollow]', 'value' : config['url_external_nofollow'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['url_external_target_blank'] }}<br /><small>{{ lang['url_external_target_blank_desc'] }}</small></td>
		<td>{{ mkSelectNY({'name' : 'save_con[url_external_target_blank]', 'value' : config['url_external_target_blank'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['timezone'] }}<br /><small>{{ lang['timezone#desc'] }}</small></td>
		<td>
		...
		<tr>
		<td width="50%">{{ lang['mailfrom_name'] }}<br /><small>{{ lang['example'] }} Administrator</small></td>
		<td><input class="mailfrom_name" type="text" id="mail_fromname" name='save_con[mailfrom_name]' value='{{ config['mailfrom_name'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['mailfrom'] }}<br /><small>{{ lang['example'] }} mailbot@server.com</small></td>
		<td><input class="mailfrom" type="text" id="mail_frommail" name='save_con[mailfrom]' value='{{ config['mailfrom'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['mail_mode'] }}:<br /><small>{{ lang['mail_mode#desc'] }}</small></td>
		...
		<tr class="useSMTP">
		<td width="50%">{{ lang['smtp_auth_login'] }}:<br /><small>{{ lang['example'] }} email@mail.ru</small></td>
		<td><input class="mailfrom" type="text" id="mail_smtp_login" name="save_con[mail][smtp][login]" value="{{ config['mail']['smtp']['login'] }}" /></td>
		</tr>
		<tr class="useSMTP">
		<td width="50%">{{ lang['smtp_auth_pass'] }}:<br /><small>{{ lang['example'] }} mySuperPassword</small></td>
		<td><input class="mailfrom" type="text" name="save_con[mail][smtp][pass]" id="mail_smtp_pass" value="{{ config['mail']['smtp']['pass'] }}" /></td>
		</tr>
		<tr>
		<td width="50%"><input type="button" class="btn btn-default" value="{{ lang['btn_checkSMTP'] }}" onclick="ngCheckEmail(); return false;"></td>
		<td style="display: block;">EMail: <input id="mail_tomail" type="email" name="" value=""></td>
		</tr>
		</table>
	</div>

	<!-- ########################## NEWS TAB ########################## -->
	<div id="userTabs-news" class="tab-pane fade">
		<table class="table table-condensed">
		<tr>
		...
		<tr>
		<td width="50%">{{ lang['news_multicat_url'] }}<br /><small>{{ lang['news_multicat_url#desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['nnavigations'] }}<br/><small>{{ lang['nnavigations_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[newsNavigationsCount]' value='{{ config['newsNavigationsCount'] }}' size="6" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['nnavigations_admin'] }}<br/><small>{{ lang['nnavigations_admin_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[newsNavigationsAdminCount]' value='{{ config['newsNavigationsAdminCount'] }}' size="6" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['category_counters'] }}<br /><small>{{ lang['category_counters_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[category_counters]', 'value' : config['category_counters'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['news_view_counters'] }}<br /><small>{{ lang['news_view_counters#desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['news.edit.split'] }}<br /><small>{{ lang['news.edit.split#desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[news.edit.split]', 'value' : config['news.edit.split'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['news_without_content'] }}<br /><small>{{ lang['news_without_content_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[news_without_content]', 'value' : config['news_without_content'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['date_adjust'] }}<br /><small>{{ lang['date_adjust_desc'] }}</small></td>
		...
		<td width="50%"><input type="text" class="form-control" name='save_con[timestamp_active]' value='{{ config['timestamp_active'] }}' size="20" /><br /><small>{{ lang['date_now'] }} {{ timestamp_active_now }}</small></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['timestamp_updated'] }}<br /><small>{{ lang['date_help'] }}</small></td>
		<td width="50%"><input type="text" class="form-control" name='save_con[timestamp_updated]' value='{{ config['timestamp_updated'] }}' size="20" /><br /><small>{{ lang['date_now'] }} {{ timestamp_updated_now }}</small></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['smilies'] }}<br /><small>{{ lang['smilies_desc'] }} (<b>,</b>)</small></td>
		<td><input type="text" class="form-control" name='save_con[smilies]' value='{{ config['smilies'] }}' style="width: 400px" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['blocks_for_reg'] }}<br /><small>{{ lang['blocks_for_reg_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[blocks_for_reg]', 'value' : config['blocks_for_reg'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['extended_more'] }}<br /><small>{{ lang['extended_more_desc'] }}</small></td>
		<td>{{ mkSelectNY({'name' : 'save_con[extended_more]', 'value' : config['extended_more'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_smilies'] }}<br /><small>{{ lang['use_smilies_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_smilies]', 'value' : config['use_smilies'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_bbcodes'] }}<br /><small>{{ lang['use_bbcodes_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_bbcodes]', 'value' : config['use_bbcodes'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_htmlformatter'] }}<br /><small>{{ lang['use_htmlformatter_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_htmlformatter]', 'value' : config['use_htmlformatter'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['default_newsorder'] }}<br /><small>{{ lang['default_newsorder_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['template_mode'] }}<br /><small>{{ lang['template_mode#desc'] }}</small></td>
	...
	<!-- ########################## USERS TAB ########################## -->
	<div id="userTabs-users" class="tab-pane fade">
		<table class="table table-condensed">
		<tr>
		<td colspan="2" class="h3">{{ lang['auth'] }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['remember'] }}<br /><small>{{ lang['remember_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[remember]', 'value' : config['remember'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['auth_module'] }}<br /><small>{{ lang['auth_module_desc'] }}</small></td>
		<td>{{ mkSelect({'name' : 'save_con[auth_module]', 'value' : config['auth_module'], 'values' : list['auth_module'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['auth_db'] }}<br /><small>{{ lang['auth_db_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['users_selfregister'] }}<br /><small>{{ lang['users_selfregister_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[users_selfregister]', 'value' : config['users_selfregister'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['register_type'] }}<br /><small>{{ lang['register_type_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['user_aboutsize'] }}<br /><small>{{ lang['user_aboutsize_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[user_aboutsize]' value='{{ config['user_aboutsize'] }}' style="width: 40px"  /></td>
		</tr>
		<tr>
		<td colspan="2" class="h3">{{ lang['users.avatars'] }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_avatars'] }}<br /><small>{{ lang['use_avatars_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_avatars]', 'value' : config['use_avatars'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['avatars_gravatar'] }}<br /><small>{{ lang['avatars_gravatar_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[avatars_gravatar]', 'value' : config['avatars_gravatar'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['avatars_url'] }}<br /><small>{{ lang['example'] }} http://server.com/uploads/avatars</small></td>
		<td><input class="folder" type="text" name='save_con[avatars_url]' value='{{ config['avatars_url'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['avatars_dir'] }}<br /><small>{{ lang['example'] }} /home/servercom/public_html/uploads/avatars/</small></td>
		<td><input class="folder" type="text" name='save_con[avatars_dir]' value='{{ config['avatars_dir'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['avatar_wh'] }}<br /><small>{{ lang['avatar_wh_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[avatar_wh]' value='{{ config['avatar_wh'] }}' style="width: 40px" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['avatar_max_size'] }}<br /><small>{{ lang['avatar_max_size_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[avatar_max_size]' value='{{ config['avatar_max_size'] }}' style="width: 40px" /></td>
		</tr>
		<tr>
		<td colspan="2" class="h3">{{ lang['users.photos'] }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['use_photos'] }}<br /><small>{{ lang['use_photos_desc'] }}</small></td>
		<td>{{ mkSelectYN({'name' : 'save_con[use_photos]', 'value' : config['use_photos'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['photos_url'] }}<br /><small>{{ lang['example'] }} http://server.com/uploads/photos</small></td>
		<td><input class="folder" type="text" name='save_con[photos_url]' value='{{ config['photos_url'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['photos_dir'] }}<br /><small>{{ lang['example'] }} /home/servercom/public_html/uploads/photos/</small></td>
		<td><input class="folder" type="text" name='save_con[photos_dir]' value='{{ config['photos_dir'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['photos_max_size'] }}<br /><small>{{ lang['photos_max_size_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[photos_max_size]' value='{{ config['photos_max_size'] }}' style="width: 40px" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['photos_thumb_size'] }}<br /><small>{{ lang['photos_thumb_size_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[photos_thumb_size_x]' value='{{ config['photos_thumb_size_x'] }}' style="width: 40px" /> x <input type="text" class="form-control" name='save_con[photos_thumb_size_y]' value='{{ config['photos_thumb_size_y'] }}' style="width: 40px" /></td>
		</tr>
		</table>
	</div>
	
	<!-- ########################## IMAGES TAB ########################## -->
	<div id="userTabs-imgfiles" class="tab-pane fade">
		<table class="table table-condensed">
		<tr>
		<td colspan="2" class="h3">{{ lang['files'] }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['files_url'] }}<br /><small>{{ lang['example'] }} http://server.com/uploads/files</small></td>
		<td><input class="folder" type="text" name='save_con[files_url]' value='{{ config['files_url'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['files_dir'] }}<br /><small>{{ lang['example'] }} /home/servercom/public_html/uploads/files/</small></td>
		<td><input class="folder" type="text" name='save_con[files_dir]' value='{{ config['files_dir'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['attach_url'] }}<br /><small>{{ lang['example'] }} http://server.com/uploads/dsn</small></td>
		<td><input class="folder" type="text" name='save_con[attach_url]' value='{{ config['attach_url'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['attach_dir'] }}<br /><small>{{ lang['example'] }} /home/servercom/public_html/uploads/dsn/</small></td>
		<td><input class="folder" type="text" name='save_con[attach_dir]' value='{{ config['attach_dir'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['files_ext'] }}<br /><small>{{ lang['files_ext_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[files_ext]' value='{{ config['files_ext'] }}' /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['files_max_size'] }}<br /><small>{{ lang['files_max_size_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[files_max_size]' value='{{ config['files_max_size'] }}' style="width: 40px" /></td>
		</tr>
		</table>
		<table class="table table-condensed">
		<tr>
		...
		<tr>
		<td width="50%">{{ lang['images_url'] }}<br /><small>{{ lang['example'] }} http://server.com/uploads/images</small></td>
		<td><input class="folder" type="text" name='save_con[images_url]' value='{{ config['images_url'] }}' style="width: 400px" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['images_dir'] }}<br /><small>{{ lang['example'] }} /home/servercom/public_html/uploads/images/</small></td>
		<td><input class="folder" type="text" name='save_con[images_dir]' value='{{ config['images_dir'] }}' style="width: 400px" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['images_ext'] }}<br /><small>{{ lang['images_ext_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[images_ext]' value='{{ config['images_ext'] }}' style="width: 400px" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['images_max_size'] }}<br /><small>{{ lang['images_max_size_desc'] }}</small></td>
		<td><input type="text" class="form-control" name='save_con[images_max_size]' value='{{ config['images_max_size'] }}' size="6" /></td>
		</tr>
		<tr>
		<td width="50%">{{ lang['images_dim_action'] }}<br /><small>{{ lang['images_dim_action#desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['images_max_dim'] }}<br /><small>{{ lang['images_max_dim#desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['thumb_mode'] }}<br /><small>{{ lang['thumb_mode_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['thumb_size'] }}<br /><small>{{ lang['thumb_size_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['thumb_quality'] }}<br /><small>{{ lang['thumb_quality_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['shadow_mode'] }}<br /><small>{{ lang['shadow_mode_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['shadow_place'] }}<br /><small>{{ lang['shadow_place_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['stamp_mode'] }}<br /><small>{{ lang['stamp_mode_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['stamp_place'] }}<br /><small>{{ lang['stamp_place_desc'] }}</small></td>
		...
		<tr>
		<td width="50%">{{ lang['wm_image'] }}<br /><small>{{ lang['wm_image_desc'] }}</small></td>
		<td>{{ mkSelect({'name' : 'save_con[wm_image]', 'value' : config['wm_image'], 'values' : list['wm_image'] }) }}</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['wm_image_transition'] }}<br /><small>{{ lang['wm_image_transition_desc'] }}</small></td>
	...
	<!-- ########################## MULTI TAB ########################## -->
	<div id="userTabs-multi" class="tab-pane fade">
		<table class="table table-condensed">
		<tr>
	...
	<!-- ########################## CACHE TAB ########################## -->
	<div id="userTabs-cache" class="tab-pane fade">
		<table class="table table-condensed">
		<tr>
		<td colspan="2" class="h3">Memcached</td>
		</tr>
		<tr>
		<td width="50%">{{ lang['memcached_enabled'] }}<br /><small>{{ lang['memcached_enabled#desc'] }}</small></td>
