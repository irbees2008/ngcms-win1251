...
<thead>
<tr class="contHead"><td>&nbsp;</td><td width="20">#</td><td width="40">{l_hdr.plugin}</td><td width="50">{l_hdr.action}</td><td>{l_hdr.description}</td><td>URL</td><td>{l_hdr.flags}</td><td>&nbsp;</td></tr>
</thead>
<tbody id="cfg.body">
</tbody>
