...
<tr><td width=100% colspan="5" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8"><a href="admin.php?mod=templates">{{ lang.templates['title'] }}</a></td></tr>
</table>
...
<tr>
 ...
 <td valign="top">
  ...
  <input style="width: 150px;" type="button" class="navbutton" value="Save file" onclick="submitTemplateEdit();" />&nbsp; &nbsp; &nbsp; <input style="width: 150px;" type="button" class="navbutton" value="Delete file"/>
  </div>
 </td>
</tr>
</table>
