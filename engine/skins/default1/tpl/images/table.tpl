...
<script src="{admin_url}/includes/js/swfobject.js"></script>
<script src="{admin_url}/includes/js/jquery.uploadify.v2.1.4.min.js"></script>
...
<h3 id="reply-title" class="comment-reply-title">{l_images_title}</h3>
