...
<input type="hidden" name="area" value="" />
	...
	<a href="?mod=news">{{ lang.addnews['news_title'] }}</a> &#8594; {{ lang.addnews['addnews_title'] }}
<!-- Main content form -->
...
<table width="100%" cellspacing="1" cellpadding="0" border="0">
  <tr>
   <td width="100">{{ lang.addnews['title'] }}</td>
   <td><input type="text" class="important" size="60" id="newsTitle" name="title" value="" tabindex="1" /></td>
  </tr>
  <tr>
...
{% else %}
    ...
    <textarea style="width: 99%; padding: 1px; margin: 1px;" name="ng_news_content" id="ng_news_content" rows="10" tabindex="2"></textarea></div>
{% endif %}
	</td>
</tr>
...
<td>
 ...
 <table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
  <td>{{ lang.editnews['editor.comminfo'] }}
  <div class="list">
...
{{ lang['editor.dedit'] }}: <b>{{ editdate }}</b>
   ...
   <td>{{ lang.editnews['category'] }}
  <div class="list">{{ mastercat }} {% if (flags.mondatory_cat) %}&nbsp; <span style="font-size: 16px; color: red;"><b>*</b></span>{% endif %}</div></td>
  </tr>
   <tr>
  <td><b>{{ lang['editor.configuration'] }}</b>
  <div class="list">
