...
if (!window.SyntaxHighlighter)
{
    var SyntaxHighlighter = function ()
    {
        var sh = 
        {
            defaults : 
            {
                "class-name" : "", "first-line" : 1, "pad-line-numbers" : true, "highlight" : null, "smart-tabs" : true, 
                "tab-size" : 4, "gutter" : true, "toolbar" : true, "collapse" : false, "auto-links" : true, 
                "light" : false, "wrap-lines" : true, "html-script" : false
            },
            config : 
            {
                useScriptTags : true, clipboardSwf : null, toolbarItemWidth : 16, toolbarItemHeight : 16, 
                bloggerMode : false, stripBrs : false, tagName : "pre", strings : 
                {
                    expandSource : "show source", viewSource : "view source", copyToClipboard : "copy to clipboard", 
                    copyToClipboardConfirmation : "The code is in your clipboard now", print : "print", 
                    
                },
                debug : false
            },
            vars : {
                discoveredBrushes : null, spaceWidth : null, printFrame : null, highlighters : {}
            },
            brushes : {}, regexLib : 
            {
                multiLineCComments : /\/\*[\s\S]*?\*\//gm, singleLineCComments : /\/\/.*$/gm, singleLinePerlComments : /#.*$/gm, 
                doubleQuotedString : /"([^\\"\n]|\\.)*"/g, singleQuotedString : /'([^\\'\n]|\\.)*'/g, 
                multiLineDoubleQuotedString : /"([^\\"]|\\.)*"/g, multiLineSingleQuotedString : /'([^\\']|\\.)*'/g, 
                xmlComments : /(<|<)!--[\s\S]*?--(>|>)/gm, url : /<\w+:\/\/[\w-.\/?%&=@:;]*>|\w+:\/\/[\w-.\/?%&=@:;]*/g, 
                phpScriptTags : {
                    left : /(<|<)\?=?/g, right : /\?(>|>)/g
                },
                aspScriptTags : {
            ...
            toolbar : 
            {
                create : function (_2)
                {
                    var _3 = document.createElement("DIV"), _4 = sh.toolbar.items;
                    _3.className = "toolbar";
                    for (var _5 in _4)
                    {
                        var _6 = _4[_5], _7 = new _6(_2), _8 = _7.create();
                ...
                {
                    var a = document.createElement("a"), _d = a.style, _e = sh.config, _f = _e.toolbarItemWidth, 
                ...
                {
                    var _17 = sh.vars.highlighters[_14], _18;
                ...
                items : 
                {
                    ...
                    copyToClipboard : function (_24)
                    {
                        ...
                        this.create = function ()
                        {
                            ...
                            var _2f = 
                            {
                                width : _28.toolbarItemWidth, height : _28.toolbarItemHeight, id : _27 + "_clipboard", 
                                type : "application/x-shockwave-flash", title : sh.config.strings.copyToClipboard
                            },
                            _30 = 
                            {
                                allowScriptAccess : "always", wmode : "transparent", flashVars : "highlighterId=" + _27, 
                                menu : "false"
                            },
                            swf = _28.clipboardSwf, _32;
                        ...
                        this.execute = function (_33, _34, _35)
                        {
                            ...
                            {
                                case "get":
                                    var _37 = sh.utils.unindent(sh.utils.fixInputString(_24.originalCode).replace(/</g, 
                                    "<").replace(/>/g, ">").replace(/&amp;/g, "&"));
                    ...
                    printSource : function (_38)
                    {
                        ...
                        {
                            var _3c = document.createElement("IFRAME"), doc = null;
                    ...
                    about : function (_42)
                    {
                        ...
                        {
                            var wnd = sh.utils.popup("", "_blank", 500, 250, "scrollbars=0"), doc = wnd.document;
            ...
            utils : 
            {
                ...
                {
                    var x = (screen.width - _53) / 2, y = (screen.height - _54) / 2;
                ...
                {
                    var _5f = sh.vars.discoveredBrushes, _60 = null;
                    if (_5f == null)
                    {
                        _5f = {};
                ...
                {
                    var _6a, _6b = {}, _6c = new XRegExp("^\\[(?<values>(.*?))\\]$"), _6d = new XRegExp("(?<name>[\\w-]+)" + "\\s*:\\s*" + "(?<value>" + "[\\w-%#]+|" + "\\[.*?\\]|" + "\".*?\"|" + "'.*?'" + ")\\s*;?", 
                    "g");
                ...
                {
                    var _7b = document.createElement("div"), _7c, _7d = 0, _7e = document.body, id = sh.utils.guid("measureSpace"), 
                    _80 = "<div class=\"", _81 = "</div>", _82 = "</span>";
                ...
                getMatches : function (_a1, _a2)
                {
                    ...
                    var _a5 = 0, _a6 = null, _a7 = [], _a8 = _a2.func ? _a2.func : defaultAdd;
                ...
                {
                    var _af = document.getElementsByTagName("script"), _b0 = [];
                ...
                {
                    var _b3 = "<![CDATA[", _b4 = "]]>", _b5 = sh.utils.trim(_b2), _b6 = false;
            ...
            highlight : function (_b7, _b8)
            {
                ...
                var _bc = _b8 ? [_b8] : toArray(document.getElementsByTagName(sh.config.tagName)), _bd = "innerHTML", 
                _be = null, _bf = sh.config;
                ...
                {
                    var _c1 = _bc[i], _c2 = sh.utils.parseParams(_c1.className), _c3, _c4, _c5;
        ...
        {
            var _cc = sh.utils.findBrush(_cb), _cd, _ce = new sh.brushes.Xml(), _cf = null;
            if (_cc == null) {
                return
            }
            _cd = new _cc();
            ...
            _ce.regexList.push({
                regex : _cd.htmlScript.code, func : process
            });
            ...
            {
                var _d5 = _d3.code, _d6 = [], _d7 = _cd.regexList, _d8 = _d3.index + _d3.left.length, 
                _d9 = _cd.htmlScript, _da;
        ...
        sh.Highlighter.prototype = 
        {
            ...
            removeNestedMatches : function ()
            {
                ...
                for (var i = 0; i < _e7.length; i++)
                {
                    ...
                    var _e9 = _e7[i], _ea = _e9.index + _e9.length;
            ...
            {
                var _ee = _ed.split("\n"), _ef = parseInt(this.getParam("first-line")), _f0 = this.getParam("pad-line-numbers"), 
                _f1 = this.getParam("highlight", []), _f2 = this.getParam("gutter");
                _ed = "";
                if (_f0 == true) {
                ...
                {
                    var _f4 = _ee[i], _f5 = /^(&nbsp;|\s)+/.exec(_f4), _f6 = "alt" + (i % 2 == 0 ? 1 : 2), 
                    _f7 = sh.utils.padNumber(_ef + i, _f0), _f8 = sh.utils.indexOf(_f1, (_ef + i).toString()) !=- 1, 
                    _f9 = null;
                    if (_f5 != null) {
                        _f9 = _f5[0].toString();
                    ...
                    _ed += "<div class=\"line " + _f6 + "\">" + "<table>" + "<tr>" + (_f2 ? "<td class=\"number\"><code>" + _f7 + "</code></td>" : "") + "<td class=\"content\">" + (_f9 != null ? "<code class=\"spaces\">" + _f9.replace(" ", 
                    "&nbsp;") + "</code>" : "") + _f4 + "</td>" + "</tr>" + "</table>" + "</div>"
                }
                return _ed;
            },
            processMatches : function (_fa, _fb)
            {
                var pos = 0, _fd = "", _fe = sh.utils.decorate, _ff = this.getParam("brush-name", "");
            ...
            {
                var conf = sh.config, vars = sh.vars, div, _10a, _10b, _10c = "important";
                this.params = {};
                this.div = null;
                this.lines = null;
                this.code = null;
                ...
                this.code = this.getParam("smart-tabs") == true ? sh.utils.processSmartTabs(this.code, 
                _10b) : sh.utils.processTabs(this.code, _10b);
            ...
            forHtmlScript : function (_10f)
            {
                ...
                {
                    left : {
                        regex : _10f.left, css : "script"
                    },
                    right : {
                        regex : _10f.right, css : "script"
                    },
                    code : new XRegExp("(?<left>" + _10f.left.source + ")" + "(?<code>.*?)" + "(?<right>" + _10f.right.source + ")", 
                    "sgi")
                }
            }
        };
...
if (!window.XRegExp)
{
    (function ()
    {
        var real = 
        {
            exec : RegExp.prototype.exec, match : String.prototype.match, replace : String.prototype.replace, 
            split : String.prototype.split
        },
        lib = {
            part : /(?:[^\\([#\s.]+|\\(?!k<[\w$]+>|[pP]{[^}]+})[\S\s]?|\((?=\?(?!#|<[\w$]+>)))+|(\()(?:\?(?:(#)[^)]*\)|<([$\w]+)>))?|\\(?:k<([\w$]+)>|[pP]{([^}]+)})|(\[\^?)|([\S\s])/g, 
            replaceVar : /(?:[^$]+|\$(?![1-9$&`']|{[$\w]+}))+|\$(?:([1-9]\d*|[$&`'])|{([$\w]+)})/g, extended : /^(?:\s+|#.*)+/, 
            quantifier : /^(?:[?*+]|{\d+(?:,\d*)?})/, classLeft : /&&\[\^?/g, classRight : /]/g
        },
        ...
        XRegExp = function (_119, _11a)
        {
            ...
            var _11a = _11a || "", _11b = _11a.indexOf("s") > -1, _11c = _11a.indexOf("x") > -1, _11d = false, 
            _11e = [], _11f = [], part = lib.part, _121, cc, len, _124, _125;
            part.lastIndex = 0;
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (_121[6])
                                {
                                    ...
                                    {
                                        cc = XRegExp.matchRecursive("&&" + _119.slice(_121.index), lib.classLeft, 
                                        lib.classRight, "", {
                                            escapeChar : "\\"
                                        })[0];
                                        _11f.push(_121[6] + cc + "]");
            ...
            _125._x = {
                source : _119, captureNames : _11d ? _11e : null
            };
            return _125;
        };
        ...
        {
            var _129 = real.exec.call(this, str), name, i, r2;
            if (_129)
            {
...
RegExp.prototype.addFlags = function (_12d)
{
    ...
    if (this._x)
    {
        _12e._x = 
        {
            source : this._x.source, captureNames : this._x.captureNames ? this._x.captureNames.slice(0) : null
        }
    }
    return _12e;
};
...
{
    var _13b = _13b || {}, _13c = _13b.escapeChar, vN = _13b.valueNames, _13a = _13a || "", _13e = _13a.indexOf("g") > -1, 
    _13f = _13a.indexOf("i") > -1, _140 = _13a.indexOf("m") > -1, _141 = _13a.indexOf("y") > -1, _13a = _13a.replace(/y/g, 
    ""), left = left instanceof RegExp ? (left.global ? left : left.addFlags("g")) : new XRegExp(left, 
    "g" + _13a), _139 = _139 instanceof RegExp ? (_139.global ? _139 : _139.addFlags("g")) : new XRegExp(_139, 
    "g" + _13a), _142 = [], _143 = 0, _144 = 0, _145 = 0, _146 = 0, _147, _148, _149, _14a, _14b, esc;
    if (_13c)
    {
        if (_13c.length > 1) {
        ...
        esc = new RegExp("^(?:" + _14b + "[\\S\\s]|(?:(?!" + left.source + "|" + _139.source + ")[^" + _14b + "])+)+", 
        _13f ? "i" : "")
    }
    while (true)
    {
