...
<h3 id="reply-title" class="comment-reply-title"><a href="admin.php?mod=extras">{l_extras}</a></h3>
<table border="0" width="100%" cellpadding="0" cellspacing="0">

<tr>
<td width=100% colspan="8" class="contentNav">
<div id="pluginTypeMenu">
<a id="pTypeAll" class="pInactive" onclick="setDisplayMode(0);">{l_list.all} ({cntAll})</a><span class="pSeparator">&nbsp;</span>
<a id="pTypeActive" class="pInactive" onclick="setDisplayMode(1);">{l_list.active} ({cntActive})</a><span class="pSeparator">&nbsp;</span>
<a id="pTypeInactive" class="pInactive" onclick="setDisplayMode(2);">{l_list.inactive} ({cntInactive})</a><span class="pSeparator">&nbsp;</span>
<a id="pTypeUninstalled" class="pInactive" onclick="setDisplayMode(3);">{l_list.needinstall} ({cntUninstalled})</a>
</div>
&nbsp;
</td>
</tr>
