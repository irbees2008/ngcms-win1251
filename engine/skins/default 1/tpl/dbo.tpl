...
<tr>
<td width=100% colspan="5" class="contentHead"><a href="admin.php?mod=dbo">{{ lang.dbo.title }}</a></td>
</tr>
</table>
...
<tr align="left">
<td width="100%" colspan="8" class="contentEdit">
{{restore}} <input class="button" type="submit" value="{{ lang.dbo.restore }}" onclick="document.forms['backups'].restore.value = 'true';" />&nbsp;
