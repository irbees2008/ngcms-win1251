<script type="text/javascript" src="plugins/autokeys/ajax.js"></script>
<style>
...
[isplugin autokeys]{autokeys}[/isplugin]
</table>
</div>
...
<input type="hidden" name="id" value="{id}" />
<input type="hidden" name="mod" value="editnews" />
<input type="submit" value="{l_comdelete}" onClick="if (!confirm('{l_sure_del_com}')) {return fa