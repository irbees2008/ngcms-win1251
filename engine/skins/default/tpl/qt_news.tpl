...
<div id="tags" class="btn-group btn-group-justified bbcodes" data-toggle="buttons">
	...
	<div class="btn-group">
		<button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-text-height" aria-hidden="true"></i><span class="caret"></span></button>
		<ul class="dropdown-menu">
			<li><a href="#" onclick="insertfortext('size',1,{area})" >очень маленький</a></li>
			<li><a href="#" onclick="insertfortext('size',2,{area})" >маленький</a></li>
			<li><a href="#" onclick="insertfortext('size',3,{area})" >средний</a></li>
			<li><a href="#" onclick="insertfortext('size',4,{area})" >большой</a></li>
			<li><a href="#" onclick="insertfortext('size',5,{area})" >очень большой</a></li>
		</ul>
	</div>

	<div class="btn-group">
		<button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-paint-brush" aria-hidden="true"></i> <span class="caret"></span></button>
		<ul class="dropdown-menu">
		<li class="dropdown-submenu">
          <a href="#" class="dropdown-toggle" tabindex="-1"><i class="fa fa-paint-brush" aria-hidden="true"></i>Вставить цвет текста </a>
		...
		<li class="dropdown-submenu">
          <a href="#" class="dropdown-toggle" tabindex="-1"><i class="fa fa-paint-brush" aria-hidden="true"></i>Вставить цвет фона текста</a>
		<ul class="dropdown-menu" style="left: 100%;">
			<div class="bb_color" >
		...
		<li class="dropdown-submenu">
		<a href="#" class="dropdown-toggle" tabindex="-1"><i class="fa fa-paint-brush" aria-hidden="true"></i>Вставить цвет для блока</a>
		<ul class="dropdown-menu" style="left: 100%;">
			<div class="bb_color" >
	...
	<div class="btn-group">
		<button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-code" aria-hidden="true"></i> <span class="caret"></span></button>
		<ul class="dropdown-menu">
		    <li><a href="#" onclick="insertext('[strong]','[/strong]', {area})" title='Код без подсветки '><i class="fa fa-code" aria-hidden="true"></i> STRONG</a></li>
			<li><a href="#" onclick="insertext('[code=html]','[/code]', {area})" title='Вставка HTML'><i class="fa fa-html5" aria-hidden="true"></i> HTML</a></li>
			<li><a href="#" onclick="insertext('[code=css]','[/code]', {area})" title='Вставка CSS'><i class="fa fa-css3" aria-hidden="true"></i> CSS</a></li>
			<li><a href="#" onclick="insertext('[code=js]','[/code]', {area})" title='Вставка JS'><i class="fa fa-file-code-o" aria-hidden="true"></i> JS</a></li>
			<li><a href="#" onclick="insertext('[code=php]','[/code]', {area})" title='Вставка PHP'><i class="fa fa-file-code-o" aria-hidden="true"></i> PHP</a></li>
			<li><a href="#" onclick="insertext('[code=sql]','[/code]', {area})" title='Вставка SQL'><i class="fa fa-database" aria-hidden="true"></i> SQL</a></li>
		</ul>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<ul class="nav nav-tabs nav-justified">
					...
					[isplugin bb_media]
					<li><a href="#tags-bbmedia" data-toggle="tab" aria-expanded="false">{l_tags.bbmedia}</a></li>
					[/isplugin]
				</ul>
				...
				<div class="tab-content">
					...
					[isplugin bb_media]
					<!-- IMG LINK -->
					<div id="tags-bbmedia" class="tab-pane">
						<div class="form-group">
							<label class="col-sm-3 control-label">Ссылка на Видео</label>
							<div class="col-sm-9">
								<input type="url" id="modal-bbmedia-url-1" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Задать размер Видео</label>
							<div class="col-sm-9">
								<div class="input-group">
									<input type="text" id="modal-bbmedia-url-2" placeholder="width" class="form-control">
									<span class="input-group-addon"> x </span>
									<input type="text" id="modal-bbmedia-url-3" placeholder="height" class="form-control">
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Ссылка на превью для видео</label>
							<div class="col-sm-9">
								<input type="url" id="modal-bbmedia-img-url-4" class="form-control" />
							</div>
						</div>
					</div>
					<!--END  IMG LINK -->
...
$(document).ready(function(){
	$('#modal-url-submit').click(function() {
		...
		if ( activeTab == 'tags-bbmedia' ){
		    var widthImg = $('#modal-bbmedia-url-2').val() ? ' width="' + $('#modal-bbmedia-url-2').val() + '"' : '';
			var heightImg = $('#modal-bbmedia-url-3').val() ? ' height="' + $('#modal-bbmedia-url-3').val() + '"' : '';
			var preview = $('#modal-bbmedia-img-url-4').val() !== '0' ? ' preview="' + $('#modal-bbmedia-img-url-4').val() + '"' : '';			
			insertext('[media '  + widthImg + heightImg + preview+ ']' + $('#modal-bbmedia-url-1').val(),'[/media]', {area})
		}
	});
});
</script>