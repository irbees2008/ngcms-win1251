...
<div id="tags" class="btn-group btn-group-justified bbcodes" data-toggle="buttons">
	...
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
		<li><a onclick="insertfortext('color',(this.value), {area})" class="get"  /><i class="fa fa-paint-brush" aria-hidden="true"></i>Вставить цвет текста </a></li>
		<li><a onclick="insertfortext('bgcolor',(this.value), {area})" class="get"  /><i class="fa fa-paint-brush" aria-hidden="true"></i>Вставить цвет фона текста </a></li>
		<li><a onclick="insertfortext('ustyle',(this.value), {area})" class="get" /><i class="fa fa-paint-brush" aria-hidden="true"></i>Вставить цвет для блока </a></li>
	    <li><i class="fa fa-paint-brush" aria-hidden="true" style="margin-left: 14px;"></i>Выбрать цвет : <input class="jscolor" value="" /></li>
	...
	<a href="#" class="btn btn-sm btn-default" onclick="insertext('[ustyle=]','[/ustyle]', {area})"><img src="{skins_url}/tags/ustyle.gif" width="16" height="16" alt="ustyle" /></a>
