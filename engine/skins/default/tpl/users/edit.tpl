				...
				<form action="admin.php?mod=users" method="post" class="form-horizontal">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea name="info" id="info" rows="8" placeholder=" Нехочу писать о себе, я стесняюсь ,да и зачем вам знать что то о обо мне? Да я такой скрытный , и не интересный, вдобавок ещё и ленивый ." value="Нехочу писать о себе, я стесняюсь ,да и зачкм вам знать что то о обо мне" class="form-control">{{ info }}</textarea>
							</div>
						</div>
					</div>
