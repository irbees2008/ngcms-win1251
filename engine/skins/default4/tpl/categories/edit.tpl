...
<tr>
<td width="100%" colspan="5" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" /><a href="?mod=categories">{{ lang['categories_title'] }}</a> &#8594; {{ lang['editing'] }} "{{ name }}"</td>
</tr>
<tr>
...
<input type="submit" value="{{ lang['save'] }}" class="button" /> <input type="button" class="button" value="{{ lang['cancel'] }}" onclick="document.location='admin.php?mod=categories';" />
