...
<tr>
<td width=100% colspan="5" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8"><a href="?mod=configuration">{{ lang['configuration_title'] }}</a></td>
</tr>
</table>
...
<tr>
<td width="50%" class="contentEntry1">{{ lang['dbhost'] }}<br /><small>{{ lang['example'] }} localhost</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input class="important" type="text" name='save_con[dbhost]' value='{{ config['dbhost'] }}' id="db_dbhost" size="40" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['dbname'] }}<br /><small>{{ lang['example'] }} ng</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input class="important" type="text" name='save_con[dbname]' value='{{ config['dbname'] }}' id="db_dbname" size="40" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['dbuser'] }}<br /><small>{{ lang['example'] }} root</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input class="important" type="text" name='save_con[dbuser]' value='{{ config['dbuser'] }}' id="db_dbuser" size="40" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['dbpass'] }}<br /><small>{{ lang['example'] }} password</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input class="password" type="password" name='save_con[dbpasswd]' value='{{ config['dbpasswd'] }}' id="db_dbpasswd" size="40" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['dbprefix'] }}<br /><small>{{ lang['example'] }} ng</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input class="important" type="text" name='save_con[prefix]' value='{{ config['prefix'] }}' size="40" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">&nbsp;</td>
<td width="50%" class="contentEntry2"><input type="button" value="{{ lang['btn_checkDB'] }}" onclick="ngCheckDB(); return false;"/></td>
</tr>
</table>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
 <td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['db_backup'] }}</td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['auto_backup'] }}<br /><small>{{ lang['auto_backup_desc'] }}</small></td>
<td width="50%" class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[auto_backup]', 'value' : config['auto_backup'] }) }}</td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['auto_backup_time'] }}<br /><small>{{ lang['auto_backup_time_desc'] }}</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input type="text" name='save_con[auto_backup_time]' value='{{ config['auto_backup_time'] }}' size="5" maxlength="5" /></td>
</tr>
</table>
<!-- END: TABLE DB//Backup -->
</div>
...
<tr>
<td class="contentEntry1">{{ lang['load'] }}<br /><small>{{ lang['load_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[load_analytics]', 'value' : config['load_analytics'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['load_profiler'] }}<br /><small>{{ lang['load_profiler_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name="save_con[load_profiler]" value="{{ config['load_profiler'] }}" /></td>
</tr>
<tr>
 <td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['security'] }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['flood_time'] }}<br /><small>{{ lang['flood_time_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[flood_time]' value='{{ config['flood_time'] }}' size="6" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['use_captcha'] }}<br /><small>{{ lang['use_captcha_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_captcha]', 'value' : config['use_captcha'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['captcha_font'] }}<br /><small>{{ lang['captcha_font_desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['use_cookies'] }}<br /><small>{{ lang['use_cookies_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_cookies]', 'value' : config['use_cookies'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['use_sessions'] }}<br /><small>{{ lang['use_sessions_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_sessions]', 'value' : config['use_sessions'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['sql_error'] }}<br /><small>{{ lang['sql_error_desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['multiext_files'] }}<br /><small>{{ lang['multiext_files_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectNY({'name' : 'save_con[allow_multiext]', 'value' : config['allow_multiext'] }) }}</td>
</tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
 <td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['debug_generate'] }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['debug'] }}<br /><small>{{ lang['debug_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[debug]', 'value' : config['debug'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['debug_queries'] }}<br /><small>{{ lang['debug_queries_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[debug_queries]', 'value' : config['debug_queries'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['debug_profiler'] }}<br /><small>{{ lang['debug_profiler_desc'] }}</small></td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
 <td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['syst'] }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['home_url'] }}<br /><small>{{ lang['example'] }} http://server.com</small></td>
<td class="contentEntry2" valign="middle"><input class="home" type="text" name='save_con[home_url]' value='{{ config['home_url'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['admin_url'] }}<br /><small>{{ lang['example'] }} http://server.com/engine</small></td>
<td class="contentEntry2" valign="middle"><input class="home" type="text" name='save_con[admin_url]' value='{{ config['admin_url'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['home_title'] }}<br /><small>{{ lang['example'] }} NGcms</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[home_title]' value="{{ config['home_title']|escape }}" size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['admin_mail'] }}<br /><small>{{ lang['example'] }} admin@server.com</small></td>
<td class="contentEntry2" valign="middle"><input class="email" type="text" name='save_con[admin_mail]' value='{{ config['admin_mail'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['lock'] }}<br /><small>{{ lang['lock_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectNY({'name' : 'save_con[lock]', 'value' : config['lock'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['lock_reason'] }}<br /><small>{{ lang['lock_reason_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[lock_reason]' value='{{ config['lock_reason'] }}' size="40" maxlength="200" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['meta'] }}<br /><small>{{ lang['meta_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[meta]', 'value' : config['meta'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['description'] }}<br /><small>{{ lang['description_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name="save_con[description]" value="{{ config['description'] }}" size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['keywords'] }}<br /><small>{{ lang['keywords_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name="save_con[keywords]" value="{{ config['keywords'] }}" size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['theme'] }}<br /><small>{{ lang['theme_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelect({'name' : 'save_con[theme]', 'value' : config['theme'], 'values' : list['theme'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['lang'] }}<br /><small>{{ lang['lang_desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['use_gzip'] }}<br /><small>{{ lang['use_gzip_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_gzip]', 'value' : config['use_gzip'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['404_mode'] }}<br /><small>{{ lang['404_mode_desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['libcompat'] }}<br /><small>{{ lang['libcompat_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[libcompat]', 'value' : config['libcompat'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['url_external_nofollow'] }}<br /><small>{{ lang['url_external_nofollow_desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['url_external_target_blank'] }}<br /><small>{{ lang['url_external_target_blank_desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['mailfrom_name'] }}<br /><small>{{ lang['example'] }} Administrator</small></td>
<td class="contentEntry2" valign="middle"><input class="mailfrom_name" type="text" id="mail_fromname" name='save_con[mailfrom_name]' value='{{ config['mailfrom_name'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['mailfrom'] }}<br /><small>{{ lang['example'] }} mailbot@server.com</small></td>
<td class="contentEntry2" valign="middle"><input class="mailfrom" type="text" id="mail_frommail" name='save_con[mailfrom]' value='{{ config['mailfrom'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['mail_mode'] }}:<br /><small>{{ lang['mail_mode#desc'] }}</small></td>
...
<tr class="useSMTP">
 <td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['smtp_config'] }}</td>
</tr>
<tr class="useSMTP">
<td class="contentEntry1">{{ lang['smtp_host'] }}:<br /><small>{{ lang['example'] }} smtp.mail.ru</small></td>
<td class="contentEntry2" valign="middle"><input class="mailfrom" type="text" name="save_con[mail][smtp][host]" id="mail_smtp_host" value="{{ config['mail']['smtp']['host'] }}" size="40" /></td>
</tr>
<tr class="useSMTP">
<td class="contentEntry1">{{ lang['smtp_port'] }}:<br /><small>{{ lang['example'] }} 25</small></td>
<td class="contentEntry2" valign="middle"><input class="mailfrom" type="text" name="save_con[mail][smtp][port]" id="mail_smtp_port" size="40" value="{{ config['mail']['smtp']['port'] }}" /></td>
</tr>
<tr class="useSMTP">
...
<td class="contentEntry2" valign="middle"><input class="mailfrom" type="text" id="mail_smtp_login" name="save_con[mail][smtp][login]" value="{{ config['mail']['smtp']['login'] }}" size="40" /></td>
</tr>
<tr class="useSMTP">
<td class="contentEntry1">{{ lang['smtp_auth_pass'] }}:<br /><small>{{ lang['example'] }} mySuperPassword</small></td>
<td class="contentEntry2" valign="middle"><input class="mailfrom" type="text" name="save_con[mail][smtp][pass]" id="mail_smtp_pass" value="{{ config['mail']['smtp']['pass'] }}" size="40" /></td>
</tr>
<tr>
<td class="contentEntry1"><input type="button" value="{{ lang['btn_checkSMTP'] }}" onclick="ngCheckEmail(); return false;"/></td>
<td class="contentEntry2" valign="middle" style="display: block;">EMail: <input class="mailfrom" id="mail_tomail" type="text" name='' value='' size="30" /></td>
</tr>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
<td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['sn'] }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['number'] }}</td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[number]' value='{{ config['number'] }}' size="6" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['news_multicat_url'] }}<br /><small>{{ lang['news_multicat_url#desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['nnavigations'] }}<br/><small>{{ lang['nnavigations_desc'] }}</small></td>
...
<tr>
    <td class="contentEntry1">{{ lang['nnavigations_admin'] }}<br/><small>{{ lang['nnavigations_admin_desc'] }}</small></td>
    <td class="contentEntry2" valign="middle"><input type="text" name='save_con[newsNavigationsAdminCount]' value='{{ config['newsNavigationsAdminCount'] }}' size="6" /></td>
</tr>
<tr>
...
<tr>
<td class="contentEntry1">{{ lang['news_view_counters'] }}<br /><small>{{ lang['news_view_counters#desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['news.edit.split'] }}<br /><small>{{ lang['news.edit.split#desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[news.edit.split]', 'value' : config['news.edit.split'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['news_without_content'] }}<br /><small>{{ lang['news_without_content_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[news_without_content]', 'value' : config['news_without_content'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['date_adjust'] }}<br /><small>{{ lang['date_adjust_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[date_adjust]' value='{{ config['date_adjust'] }}' size="6" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['timestamp_active'] }}<br /><small>{{ lang['date_help'] }}</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input type="text" name='save_con[timestamp_active]' value='{{ config['timestamp_active'] }}' size="20" /><br /><small>{{ lang['date_now'] }} {{ timestamp_active_now }}</small></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['timestamp_updated'] }}<br /><small>{{ lang['date_help'] }}</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input type="text" name='save_con[timestamp_updated]' value='{{ config['timestamp_updated'] }}' size="20" /><br /><small>{{ lang['date_now'] }} {{ timestamp_updated_now }}</small></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['smilies'] }}<br /><small>{{ lang['smilies_desc'] }} (<b>,</b>)</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[smilies]' value='{{ config['smilies'] }}' style="width: 400px" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['blocks_for_reg'] }}<br /><small>{{ lang['blocks_for_reg_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[blocks_for_reg]', 'value' : config['blocks_for_reg'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['extended_more'] }}<br /><small>{{ lang['extended_more_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectNY({'name' : 'save_con[extended_more]', 'value' : config['extended_more'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['use_smilies'] }}<br /><small>{{ lang['use_smilies_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_smilies]', 'value' : config['use_smilies'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['use_bbcodes'] }}<br /><small>{{ lang['use_bbcodes_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_bbcodes]', 'value' : config['use_bbcodes'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['use_htmlformatter'] }}<br /><small>{{ lang['use_htmlformatter_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_htmlformatter]', 'value' : config['use_htmlformatter'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['default_newsorder'] }}<br /><small>{{ lang['default_newsorder_desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['template_mode'] }}<br /><small>{{ lang['template_mode#desc'] }}</small></td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
<td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['users'] }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['users_selfregister'] }}<br /><small>{{ lang['users_selfregister_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[users_selfregister]', 'value' : config['users_selfregister'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['register_type'] }}<br /><small>{{ lang['register_type_desc'] }}</small></td>
...
<tr>
<td class="contentEntry1">{{ lang['user_aboutsize'] }}<br /><small>{{ lang['user_aboutsize_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[user_aboutsize]' value='{{ config['user_aboutsize'] }}' style="width: 40px"  /></td>
</tr>
<tr>
<td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['users.avatars'] }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['use_avatars'] }}<br /><small>{{ lang['use_avatars_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_avatars]', 'value' : config['use_avatars'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['avatars_gravatar'] }}<br /><small>{{ lang['avatars_gravatar_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[avatars_gravatar]', 'value' : config['avatars_gravatar'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['avatars_url'] }}<br /><small>{{ lang['example'] }} http://server.com/uploads/avatars</small></td>
<td class="contentEntry2" valign="middle"><input class="folder" type="text" name='save_con[avatars_url]' value='{{ config['avatars_url'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['avatars_dir'] }}<br /><small>{{ lang['example'] }} /home/servercom/public_html/uploads/avatars/</small></td>
<td class="contentEntry2" valign="middle"><input class="folder" type="text" name='save_con[avatars_dir]' value='{{ config['avatars_dir'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['avatar_wh'] }}<br /><small>{{ lang['avatar_wh_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[avatar_wh]' value='{{ config['avatar_wh'] }}' style="width: 40px" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['avatar_max_size'] }}<br /><small>{{ lang['avatar_max_size_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[avatar_max_size]' value='{{ config['avatar_max_size'] }}' style="width: 40px" /></td>
</tr>
<tr>
<td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['users.photos'] }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['use_photos'] }}<br /><small>{{ lang['use_photos_desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[use_photos]', 'value' : config['use_photos'] }) }}</td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['photos_url'] }}<br /><small>{{ lang['example'] }} http://server.com/uploads/photos</small></td>
<td class="contentEntry2" valign="middle"><input class="folder" type="text" name='save_con[photos_url]' value='{{ config['photos_url'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['photos_dir'] }}<br /><small>{{ lang['example'] }} /home/servercom/public_html/uploads/photos/</small></td>
<td class="contentEntry2" valign="middle"><input class="folder" type="text" name='save_con[photos_dir]' value='{{ config['photos_dir'] }}' size="40" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['photos_max_size'] }}<br /><small>{{ lang['photos_max_size_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[photos_max_size]' value='{{ config['photos_max_size'] }}' style="width: 40px" /></td>
</tr>
<tr>
<td class="contentEntry1">{{ lang['photos_thumb_size'] }}<br /><small>{{ lang['photos_thumb_size_desc'] }}</small></td>
<td class="contentEntry2" valign="middle"><input type="text" name='save_con[photos_thumb_size_x]' value='{{ config['photos_thumb_size_x'] }}' style="width: 40px" /> x <input type="text" name='save_con[photos_thumb_size_y]' value='{{ config['photos_thumb_size_y'] }}' style="width: 40px" /></td>
</tr>
</table>
</div>
<!-- ########################## IMAGES TAB ########################## -->
...
<div id="userTabs-auth">
 <table border="0" width="100%" cellspacing="0" cellpadding="0">
 <tr>
 <td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['auth'] }}</td>
 </tr>
 <tr>
 <td class="contentEntry1">{{ lang['remember'] }}<br /><small>{{ lang['remember_desc'] }}</small></td>
 <td class="contentEntry2" valign="middle">{{ mkSelectYN({'name' : 'save_con[remember]', 'value' : config['remember'] }) }}</td>
 </tr>
 <tr>
 <td class="contentEntry1">{{ lang['auth_module'] }}<br /><small>{{ lang['auth_module_desc'] }}</small></td>
 ...
 <tr>
 <td class="contentEntry1">{{ lang['auth_db'] }}<br /><small>{{ lang['auth_db_desc'] }}</small></td>
...
<div id="userTabs-multi">
 <table border="0" width="100%" cellspacing="0" cellpadding="0">
 <tr>
 <td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['multi_info'] }}</td>
 </tr>
 <tr>
 <td width="50%" class="contentEntry1" valign=top>{{ lang['mydomains'] }}<br /><small>{{ lang['mydomains_desc'] }}</small></td>
 <td width="50%" class="contentEntry2" valign="middle"><textarea cols=45 rows=3 name="save_con[mydomains]">{{ config['mydomains'] }}</textarea></td>
 </tr>
 <tr><td colspan="2">&nbsp;</td></tr>
 <tr>
 <td colspan="2" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" />{{ lang['multisite'] }}</td>
 </tr>
 <tr><td colspan=2>
...
<tr>
<td class="contentEntry1">{{ lang['memcached_enabled'] }}<br /><small>{{ lang['memcached_enabled#desc'] }}</small></td>
<td class="contentEntry2" valign="middle">{{ mkSelectNY({'name' : 'save_con[use_memcached]', 'value' : config['use_memcached'] }) }}</td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['memcached_ip'] }}<br /><small>{{ lang['example'] }} localhost</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input class="important" type="text" name='save_con[memcached_ip]' value='{{ config['memcached_ip'] }}' id="memcached_ip" size="40" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['memcached_port'] }}<br /><small>{{ lang['example'] }} 11211</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input class="important" type="text" name='save_con[memcached_port]' value='{{ config['memcached_port'] }}' id="memcached_port" size="40" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{{ lang['memcached_prefix'] }}<br /><small>{{ lang['example'] }} ng</small></td>
<td width="50%" class="contentEntry2" valign="middle"><input class="important" type="text" name='save_con[memcached_prefix]' value='{{ config['memcached_prefix'] }}' id="memcached_prefix" size="40" /></td>
</tr>
<tr>
<td width="50%" class="contentEntry1">&nbsp;</td>
<td width="50%" class="contentEntry2"><input type="button" value="{{ lang['btn_checkMemcached'] }}" onclick="ngCheckMemcached(); return false;"/></td>
</tr>
</table>
</div>
