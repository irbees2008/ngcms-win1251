...
<td width=50% class=contentEntry2 valign=middle><textarea name="info" rows="7" cols="60" value="Нехочу писать о себе, я стесняюсь ,да и зачкм вам знать что то о обо мне">{{ info }}</textarea></td>
</tr>
</table>
