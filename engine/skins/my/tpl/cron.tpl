...
{% endfor %}
                 ...
                 <div class="panel-body">
                     <button class="btn btn-success" type="submit" onclick='document.location="?mod=extra-config&plugin=xfields&action=add&section={{ sectionID }}";'>{{ lang.cron['commit_change'] }}</button>
                 </div>
             </form>
         </div>
     </div>
