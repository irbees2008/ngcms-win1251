...
<div id="loading-layer"><i class="fa fa-spinner fa-pulse"></i> $lang[loading]</div>
	...
	<div class="side-menu-container">
		<ul class="navbar-nav" id="navmenu-v">
			<li><a href="$PHP_SELF?mod=news"><i class="fa fa-newspaper-o"></i> Все новости</a></li>
			<li><a href="$PHP_SELF?mod=news&action=add">Добавить новость</a></li>
		  <li><a href="$PHP_SELF?mod=categories"><i class="fa fa-folder-open-o"></i> Категории новостей</a></li>
			<li><a href="$PHP_SELF?mod=categories&action=add">Добавить категорию</a></li>
			<li><a href="$PHP_SELF?mod=static"><i class="fa fa-file-text-o"></i> Статические страницы</a></li>
